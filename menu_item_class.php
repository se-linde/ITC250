...
$items[] = new item('Mahi Mahi Tacos', 'A delicious combination of fresh Mahi Mahi with seasoned coleslaw', 9.95);
$items[] = new item('Halibut Tacos', 'Alaskan Halibut with just the right amount of spice!!', 13.95);
